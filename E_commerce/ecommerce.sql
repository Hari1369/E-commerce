...
\restrict hU7MDOqQlAPc1892cuMx3sdmLSOTCdx1BJBvAyIljKsmVZbTaX3clHJXGZ7sqAk
...
CREATE TABLE public.brand (
    id bigint NOT NULL,
    brand character varying(200) CONSTRAINT "brand_Brand_not_null" NOT NULL,
    is_active boolean NOT NULL,
...
CREATE TABLE public.product (
    ...
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL,
    brand_id bigint CONSTRAINT product_brand_id_id_not_null NOT NULL
);
...
CREATE TABLE public.sub_category (
    ...
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL,
    product_id bigint CONSTRAINT sub_category_product_id_id_not_null NOT NULL,
...
33	Can add sub_ category	9	add_sub_category
34	Can change sub_ category	9	change_sub_category
35	Can delete sub_ category	9	delete_sub_category
36	Can view sub_ category	9	view_sub_category
\.
...
COPY public.brand (id, brand, is_active, created_at, updated_at) FROM stdin;
2	Raymonds	t	2026-09-21 09:41:38.157799+00	2026-09-21 09:41:38.157813+00
3	Allen Solly	t	2026-09-21 10:15:16.792656+00	2026-09-21 10:15:16.792678+00
4	US Polo Assn	t	2026-09-21 10:16:37.175722+00	2026-09-21 10:16:37.175739+00
5	Rare Rabbit	f	2026-09-21 10:16:55.396382+00	2026-09-21 10:16:55.396392+00
6	Snitch	t	2026-09-21 10:17:18.970998+00	2026-09-21 10:31:05.67563+00
1	Fab India	t	2026-09-21 09:37:13.85161+00	2026-09-21 10:33:34.656284+00
\.
...
1	contenttypes	0001_initial	2026-09-21 07:57:21.837789+00
2	auth	0001_initial	2026-09-21 07:57:21.938588+00
3	admin	0001_initial	2026-09-21 07:57:21.972616+00
4	admin	0002_logentry_remove_auto_add	2026-09-21 07:57:21.992768+00
5	admin	0003_logentry_add_action_flag_choices	2026-09-21 07:57:22.011352+00
6	contenttypes	0002_remove_content_type_name	2026-09-21 07:57:22.032964+00
7	auth	0002_alter_permission_name_max_length	2026-09-21 07:57:22.04434+00
8	auth	0003_alter_user_email_max_length	2026-09-21 07:57:22.054798+00
9	auth	0004_alter_user_username_opts	2026-09-21 07:57:22.064408+00
10	auth	0005_alter_user_last_login_null	2026-09-21 07:57:22.075495+00
11	auth	0006_require_contenttypes_0002	2026-09-21 07:57:22.078221+00
12	auth	0007_alter_validators_add_error_messages	2026-09-21 07:57:22.089224+00
13	auth	0008_alter_user_username_max_length	2026-09-21 07:57:22.111828+00
14	auth	0009_alter_user_last_name_max_length	2026-09-21 07:57:22.125239+00
15	auth	0010_alter_group_name_max_length	2026-09-21 07:57:22.142827+00
16	auth	0011_update_proxy_permissions	2026-09-21 07:57:22.155548+00
17	auth	0012_alter_user_first_name_max_length	2026-09-21 07:57:22.171795+00
18	members	0001_initial	2026-09-21 07:57:22.20797+00
19	members	0002_rename_brand_brand_brand_and_more	2026-09-21 07:57:22.249645+00
20	sessions	0001_initial	2026-09-21 07:57:22.269531+00
21	members	0003_alter_brand_brand_alter_product_product_name_and_more	2026-09-21 08:53:07.791261+00
22	members	0004_sub_category_brand	2026-09-21 09:25:14.057398+00
\.
...
COPY public.product (id, product_name, is_active, created_at, updated_at, brand_id) FROM stdin;
1	Sherwani	t	2026-09-21 09:43:19.868081+00	2026-09-21 09:43:19.868093+00	1
2	Indo-Western	t	2026-09-21 09:48:26.616836+00	2026-09-21 09:48:26.616851+00	2
\.
...
COPY public.sub_category (id, category_name, price, created_at, updated_at, product_id, brand_id) FROM stdin;
1	Zari Sherwani	6500	2026-09-21 10:38:25.399035+00	2026-09-21 10:38:25.399047+00	1	2
\.
...
--
-- Name: brand brand_brand_b22a0309_uniq; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.brand
    ADD CONSTRAINT brand_brand_b22a0309_uniq UNIQUE (brand);


--
-- Name: brand brand_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: product product_product_name_a5bcb672_uniq; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.product
    ADD CONSTRAINT product_product_name_a5bcb672_uniq UNIQUE (product_name);


--
-- Name: sub_category sub_category_category_name_3c7eb87d_uniq; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.sub_category
    ADD CONSTRAINT sub_category_category_name_3c7eb87d_uniq UNIQUE (category_name);


--
-- Name: sub_category sub_category_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: brand_brand_b22a0309_like; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX brand_brand_b22a0309_like ON public.brand USING btree (brand varchar_pattern_ops);
...
--
-- Name: product_brand_id_id_3a15f341; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX product_brand_id_id_3a15f341 ON public.product USING btree (brand_id);


--
-- Name: product_product_name_a5bcb672_like; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX product_product_name_a5bcb672_like ON public.product USING btree (product_name varchar_pattern_ops);


--
-- Name: sub_category_brand_id_5ec2bc82; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX sub_category_brand_id_5ec2bc82 ON public.sub_category USING btree (brand_id);


--
-- Name: sub_category_category_name_3c7eb87d_like; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX sub_category_category_name_3c7eb87d_like ON public.sub_category USING btree (category_name varchar_pattern_ops);


--
-- Name: sub_category_product_id_id_d3ab0a50; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX sub_category_product_id_id_d3ab0a50 ON public.sub_category USING btree (product_id);
...
--
-- Name: product product_brand_id_9bf06fde_fk_brand_id; Type: FK CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: sub_category sub_category_brand_id_5ec2bc82_fk_brand_id; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.sub_category
    ADD CONSTRAINT sub_category_brand_id_5ec2bc82_fk_brand_id FOREIGN KEY (brand_id) REFERENCES public.brand(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: sub_category sub_category_product_id_cd05dc57_fk_product_id; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.sub_category
    ADD CONSTRAINT sub_category_product_id_cd05dc57_fk_product_id FOREIGN KEY (product_id) REFERENCES public.product(id) DEFERRABLE INITIALLY DEFERRED;
...
\unrestrict hU7MDOqQlAPc1892cuMx3sdmLSOTCdx1BJBvAyIljKsmVZbTaX3clHJXGZ7sqAk
